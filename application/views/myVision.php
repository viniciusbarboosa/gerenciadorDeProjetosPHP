        ...
        <div class="col-md-8">
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <span style="background-color:greenyellow">&#8203 &#8203 &#8203; &#8203; &#8203;&#8203; &#8203;&#8203;&#8203; &#8203; &#8203;</span> Caso #123: Erro de Interface
                </div>
                <div class="card-body">
                    <p class="card-text">Descrição do erro de interface.</p>
                </div>
            </div>
            <div class="card mb-3">
                <div class="card-header">
                    Caso #124: Problema de Segurança
                </div>
                <div class="card-body">
                    <p class="card-text">Descrição do problema de segurança.</p>
                </div>
            </div>
        </div>
        <div class="col-md-4">
